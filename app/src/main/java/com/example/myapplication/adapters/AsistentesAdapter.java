...
public class AsistentesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AsistentesAdapter(ArrayList<Asistentes> asistentesList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            Asistentes currentItem = asistentesList.get(position - 1); // Ajuste de posición por la cabecera
            ...
            itemViewHolder.goals.setText(String.valueOf(currentItem.getCantidad()));
        }
    }

    @Override
    public int getItemCount() {
        return asistentesList.size() + 1; // +1 por la cabecera
    }
}
